...
const TEXTS := {
	"en": {
		...
		"line_defense": "Line Defense", "siege_battery": "Siege Battery", "anti_swarm_array": "Anti-Swarm Array", "relay_support": "Relay Support", "siege_bombard": "Siege Bombard", "tower_control": "%s Control", "sell_tower": "Sell Tower (+%d)", "tower_stats": "Damage: %.1f\nDPS: %.1f\nDamage dealt: %.0f\nKills: %d\nRange: %.0f\nFire rate: %.2f\nSell refund: +%d",
	...
	"de": {
		...
		"victory": "SIEG", "game_over": "NIEDERLAGE", "target_secured": "Ziel gesichert", "base_integrity_collapsed": "Basisintegrität zusammengebrochen", "victory_hint": "Freien Modus fortsetzen, neu starten oder zum Menü zurückkehren", "defeat_hint": "Drücke R, starte neu oder kehre zum Menü zurück",
		"ready": "Bereit", "blocked_outside_build_zone": "Blockiert: außerhalb der Bauzone", "blocked_lane": "Blockiert: zu nah am Pfad", "blocked_tower": "Blockiert: zu nah an einem Turm", "blocked_credits": "Blockiert: nicht genug Credits", "blocked": "Blockiert",
		...
		"boss_terminated": "BOSS ELIMINIERT", "boss_neutralized": "Belagerer neutralisiert", "boss_clear": "[KLAR] Boss-Signal eliminiert", "fortress_lost": "FESTUNG VERLOREN", "run_over_restart": "Run vorbei - drücke R zum Neustart", "failure_base": "[FEHLSCHLAG] Basisintegrität zusammengebrochen",
		...
		"line_defense": "Linienverteidigung", "siege_battery": "Belagerungsbatterie", "anti_swarm_array": "Anti-Schwarm-Array", "relay_support": "Relais-Unterstützung", "siege_bombard": "Belagerungsbombarde", "tower_control": "%s Steuerung", "sell_tower": "Turm verkaufen (+%d)", "tower_stats": "Schaden: %.1f\nDPS: %.1f\nVerursachter Schaden: %.0f\nAbschüsse: %d\nReichweite: %.0f\nFeuerrate: %.2f\nVerkaufswert: +%d",
